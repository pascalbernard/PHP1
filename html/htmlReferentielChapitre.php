...
function request(oSelect,php,formulaire) {
	...
	xhr.send("IdEditor=" + value+"&htmlAppelant="+formulaire);
}
...
<fieldset>
	...
	<div id="chapitreBox">
		<p id="chapitre">
			<select id="editorsSelect" onchange="request(this,'XMLHttpRequest_getListData.php','htmlReferentielChapitre');">
